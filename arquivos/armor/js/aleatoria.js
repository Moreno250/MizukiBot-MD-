...
var mensagens = [
    ...
    "*[ ! ] Aguarde amigo, estou enviando.. ⏳*",
    "*Vai beber uma água, já estou terminando.. 💧*",
    "*Opa, calma ae, tô enviando já! 👀*",
    "*❬❗❭ Aguarde 5 segundos ⏱️*",
    "*Seu pedido é uma ordem companheiro.. 🙏*",
    "*Oi filho de Deus, calma ae, tô terminando.. 😂*",
    "*Oi princesa, já estou preparando pra enviar.. 👑*",
    "*Salve mano, só aguarde um pouquinho! 🤙*",
    "*Aquieta o coração amigo, já estou enviando! ❤️‍🔥*",
    "*Espere sentado que estou enviando! 🛋️*",
    "*Pisa no freio aí amigo, tô enviando rsrs! 🛑*",
    "*Foi daqui que pediram comando? 🙋‍♂️*",
    "*Em 365 dias úteis termino o comando! 🗓️ (brincadeira)*",
    "*Não precisa gritar, tô enviando seu pedido! 🤫*",
    "*Aproveita que tô terminando aqui e beba água! 💦*",
